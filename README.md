...
- 拷贝至系统中
  ...
  本项目未对程序本体做任何修改。我只写了一个脚本，用于给MicroWeb启动代理的同时加载本地网页。因为MicroWeb直接启动本体似乎会出现卡在初始化界面的情况，因此我写了一个简单的本地网页作为开始菜单。

  #### 8.本项目所有文件来源于网络，且已给出链接，仅可作为个人交流学习使用。若发现本项目侵犯了您的权力，请联系3636230447@qq.com，以便删除处理。
